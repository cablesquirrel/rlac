---
title: ESP32 Project - 🐔 Chicken Water Controller (April 2023)
date: 04-18-2023
...
<Image src={control_box} alt="Inside of control box" width={imageWidth} quality="max" />

Tub in wooden frame

<Image src={tub_in_frame} alt="Tub in wooden frame" width={imageWidth} quality="mid" />

Assembled frame

<Image src={assembled_frame} alt="Assembled frame" width={imageWidth} quality="mid" />

Control box mounted in chicken coop

<Image src={control_box_2} alt="Control box mounted in chicken coop" width={imageWidth} quality="max" />

Drain pipe

<Image src={drain_pipe} alt="Drain pipe" width={imageWidth} quality="mid" />

Drain valve

<Image src={drain_valve} alt="Drain valve" width={imageWidth} quality="mid" />

Fill valve

<Image src={fill_valve} alt="Fill valve" width={imageWidth} quality="mid" />

Completed system

<Image src={completed} alt="Completed system" width={imageWidth} quality="mid" />
